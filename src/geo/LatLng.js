...
export class LatLng {
	...
	distanceTo(other) {
	  return Earth.distance(this, LatLng.toLatLng(other));
	}
	...
	static toLatLng(obj) {
	  ...
	  if (Array.isArray(obj)) {
		return new LatLng(obj[0], obj[1], obj[2]);
	  }
	  if (obj.lat !== undefined && obj.lng !== undefined) {
		return new LatLng(obj.lat, obj.lng, obj.alt);
	  }
	  throw new Error('Invalid LatLng object');
	}
  
	static toLatLngBounds(southWest, northEast) {
